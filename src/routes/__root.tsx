  ...
  head: () => ({
    meta: [
      ...
      { title: "Halcyon Works — Applied Innovation Studio" },
      {
        name: "description",
        content:
          "Halcyon Works is an applied innovation studio building SaaS products, AI systems, automation, growth programs, IoT and medical research tooling.",
      },
      { name: "author", content: "Halcyon Works" },
